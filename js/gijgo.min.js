...
(gj.widget = function () {
      ...
      return (
        "normal" === d.lineHeight
          ? ((c = parseInt(d.height, 10)),
            ...
            (c +=
              parseInt(d.borderTop || 0, 10) +
              parseInt(d.borderBottom || 0, 10)))
          : (c = parseInt(d.height, 10)),
        b &&
          (c +=
      ...
      return (
        "normal" === d.lineHeight
          ? ((c = parseInt(d.width, 10)),
            ...
            (c +=
              parseInt(d.borderLeft || 0, 10) +
              parseInt(d.borderRight || 0, 10)))
          : (c = parseInt(d.width, 10)),
        b &&
          (c +=
    ...
    resize: function (a, b) {
      ...
      return (
        ...
        c.hasClass("gj-resizable-n")
          ? ((f = d.height() - b.top), (h = d.offset().top + b.top))
          : c.hasClass("gj-resizable-e")
          ? (g = d.width() + b.left)
          : c.hasClass("gj-resizable-s")
          ? (f = d.height() + b.top)
          : c.hasClass("gj-resizable-w")
          ? ((g = d.width() - b.left), (i = d.offset().left + b.left))
          : c.hasClass("gj-resizable-ne")
          ? ((f = d.height() - b.top),
            (h = d.offset().top + b.top),
            (g = d.width() + b.left))
          : c.hasClass("gj-resizable-nw")
          ? ((f = d.height() - b.top),
            (h = d.offset().top + b.top),
            (g = d.width() - b.left),
            (i = d.offset().left + b.left))
          : c.hasClass("gj-resizable-se")
          ? ((f = d.height() + b.top), (g = d.width() + b.left))
          : c.hasClass("gj-resizable-sw") &&
            ((f = d.height() + b.top),
            (g = d.width() - b.left),
            (i = d.offset().left + b.left)),
        f &&
          (!e.minHeight || f >= e.minHeight) &&
          (!e.maxHeight || f <= e.maxHeight) &&
          (d.height(f), h && d.css("top", h), (j = !0)),
        g &&
          (!e.minWidth || g >= e.minWidth) &&
          (!e.maxWidth || g <= e.maxWidth) &&
          (d.width(g), i && d.css("left", i), (j = !0)),
        j && gj.dialog.events.resize(d),
        j
      );
    },
    open: function (a, b) {
  ...
  (gj.draggable.config = {
    base: { handle: void 0, vertical: !0, horizontal: !0 },
  }),
  (gj.draggable.methods = {
    init: function (a) {
      ...
      return (
        ...
        c.attr("data-draggable", "true"),
        (b = gj.draggable.methods.getHandleElement(c)),
        b.on("touchstart mousedown", function (a) {
          c.attr("data-draggable-dragging", !0),
            c.removeAttr("data-draggable-x").removeAttr("data-draggable-y"),
            c.css("position", "absolute"),
            gj.documentManager.subscribeForEvent(
              "touchmove",
              c.data("guid"),
              gj.draggable.methods.createMoveHandler(c)
            ),
            gj.documentManager.subscribeForEvent(
              "mousemove",
              c.data("guid"),
        ...
        gj.documentManager.subscribeForEvent(
          "mouseup",
          c.data("guid"),
          gj.draggable.methods.createUpHandler(c)
        ),
        gj.documentManager.subscribeForEvent(
          "touchend",
          c.data("guid"),
    ...
    createUpHandler: function (a) {
      return function (b) {
        "true" === a.attr("data-draggable-dragging") &&
          (a.attr("data-draggable-dragging", !1),
          gj.documentManager.unsubscribeForEvent("mousemove", a.data("guid")),
          gj.documentManager.unsubscribeForEvent("touchmove", a.data("guid")),
          gj.draggable.events.stop(a, { left: a.mouseX(b), top: a.mouseY(b) }));
      };
    },
    createMoveHandler: function (a) {
      return function (b) {
        var c, d, e, f, g, h;
        "true" === a.attr("data-draggable-dragging") &&
          ((c = Math.round(a.mouseX(b))),
          (d = Math.round(a.mouseY(b))),
          (g = a.attr("data-draggable-x")),
          (h = a.attr("data-draggable-y")),
          g && h
            ? ((e = a.data("horizontal") ? c - parseInt(g, 10) : 0),
              (f = a.data("vertical") ? d - parseInt(h, 10) : 0),
              !1 !== gj.draggable.events.drag(a, e, f, c, d) &&
                gj.draggable.methods.move(a, e, f))
            : gj.draggable.events.start(a, c, d),
          a.attr("data-draggable-x", c),
          a.attr("data-draggable-y", d));
      };
    },
    move: function (a, b, c) {
      var d = a.get(0),
  ...
  (gj.draggable.events = {
    ...
    start: function (a, b, c) {
      a.triggerHandler("start", [{ top: c, left: b }]);
    },
    stop: function (a, b) {
  ...
  (gj.droppable.methods = {
      ...
      return function (b) {
        if (a.isDragging) {
          var c = a.data("hoverClass"),
            d = { left: a.mouseX(b), top: a.mouseY(b) },
    ...
    isOver: function (a, b) {
      ...
      return (
        ...
        b.left > offsetLeft &&
          b.left < offsetLeft + a.outerWidth(!0) &&
          b.top > c &&
          b.top < c + a.outerHeight(!0)
      );
    },
    destroy: function (a) {
      return (
        ...
        (c.editor
          ? (gj.grid.plugins.inlineEditing.private.updateOtherCells(a, c.mode),
            ...
            "TEXT" === g.prop("type").toUpperCase()
              ? gj.grid.plugins.inlineEditing.private.setCaretAtEnd(g[0])
              : g.focus(),
        ...
        return function (e, f) {
          ...
          if (
            ...
            f &&
              ...
              (l = parseInt($(j).attr("width"), 10) - f.left),
  ...
  (gj.tree.methods = {
    ...
    getRecords: function (a, b) {
      ...
      for (c = 0; c < b.length; c++)
        (d =
          g.primaryKey && b[c][g.primaryKey]
            ? b[c][g.primaryKey]
            : g.autoGenId++),
          (e = { id: d, data: b[c] }),
          b[c][g.childrenField] && b[c][g.childrenField].length
            ? ((e.children = gj.tree.methods.getRecords(
                a,
                b[c][g.childrenField]
              )),
              delete b[c][g.childrenField])
            : (e.children = []),
          f.push(e);
      return f;
    },
    ...
    appendNode: function (a, b, c, d, e) {
      var f,
        ...
        j,
        k = a.data(),
        g = $('<li data-id="' + c.id + '" data-role="node" />').addClass(
          k.style.item
        ),
        l = $('<div data-role="wrapper" />'),
        m = $('<span data-role="expander" data-mode="close"></span>').addClass(
          k.style.expander
        ),
        n = $('<span data-role="display">' + c.data[k.textField] + "</span>"),
        o =
          void 0 !== c.data[k.hasChildrenField] &&
          "true" === c.data[k.hasChildrenField].toString().toLowerCase(),
        p =
          void 0 !== c.data[k.disabledField] &&
          "true" === c.data[k.disabledField].toString().toLowerCase();
      if (
        (k.indentation &&
          l.append(
      ...
      k.imageCssClassField && c.data[k.imageCssClassField]
        ...
        : k.imageHtmlField &&
          ...
          ((i = $(
            '<span data-role="image">' + c.data[k.imageHtmlField] + "</span>"
          )),
          i.insertBefore(n)),
    ...
    getById: function (a, b, c) {
      ...
      for (d = 0; d < c.length; d++) {
        ...
        if (
          c[d].children &&
          c[d].children.length &&
          (e = gj.tree.methods.getById(a, b, c[d].children))
        )
          break;
      }
      return e;
    ...
    getDataByText: function (a, b, c) {
      ...
      for (d = 0; d < c.length; d++) {
        ...
        if (
          c[d].children &&
          c[d].children.length &&
          (e = gj.tree.methods.getDataByText(a, b, c[d].children))
        )
          break;
      }
      return e;
    ...
    getAll: function (a, b) {
      ...
      for (c = 0; c < b.length; c++)
        (d = JSON.parse(JSON.stringify(b[c].data))),
          b[c].children.length &&
            (d[f] = gj.tree.methods.getAll(a, b[c].children)),
          e.push(d);
      return e;
    },
      ...
      return (
        c && c.length
          ? ("li" === c[0].tagName.toLowerCase() &&
              ...
              (c = c.children("ul"))),
            gj.tree.methods
              .getById(a, c.parent().data("id"), a.data("records"))
              .children.push(f))
    ...
    removeDataById: function (a, b, c) {
      ...
      for (d = 0; d < c.length; d++) {
        ...
        c[d].children &&
          c[d].children.length &&
          gj.tree.methods.removeDataById(a, b, c[d].children);
      }
    },
            ...
            d.each(function () {
              ...
              if (i.droppable("isOver", g))
                return (
                  ...
                  (e = c.children("ul")),
                  0 === e.length &&
                    ((e = $("<ul />").addClass(f.style.list)), c.append(e)),
                  !1 !==
              ...
              e.each(function () {
                ...
                if (i.droppable("isOver", g))
                  return (
                    ...
                    (h = b.data("id")),
                    (f =
                      c.prevAll('li:not([data-id="' + h + '"])').length +
                      (e ? 1 : 2)),
                    !1 !==
                      gj.tree.plugins.dragAndDrop.events.nodeDrop(
                        a,
                        h,
                        c.parent("ul").parent("li").data("id"),
                        f
                      ) &&
      ...
      createDoneHandler: function (a, b) {
        return function (c) {
          ...
          if (
            ...
            for (
              f = $("<ul />").addClass(g.style.list), b.append(f), d = 0;
              d < c.length;
              d++
            )
              a.addNode(c[d], f);
  ...
  (gj.editor.methods = {
    ...
    initialize: function (a) {
      ...
      if (
        ...
        0 === e.length && ((e = $('<div role="body"></div>')), $(d).append(e)),
  ...
  (gj.dropdown.methods = {
    ...
    setListPosition: function (a, b, c) {
      ...
      gj.core.setChildPosition(a, b),
        ...
        !isNaN(d) &&
        "auto" === c.maxHeight &&
        g.top + d + e > window.innerHeight
          ? (f = window.innerHeight - g.top - e - 3)
          : !isNaN(d) &&
            !isNaN(c.maxHeight) &&
            c.maxHeight < d &&
            (f = c.maxHeight),
  ...
  (gj.datepicker = {
    plugins: {},
    messages: { "en-us": { weekDays: ["S", "M", "T", "W", "T", "F", "S"] } },
  }),
  ...
  (gj.datepicker.methods = {
    ...
    initialize: function (a) {
      ...
      (c =
        "bootstrap" === d.uiLibrary
          ? $(
              '<span class="input-group-addon">' + d.icons.rightIcon + "</span>"
            )
          : "bootstrap4" === d.uiLibrary
          ? $(
        ...
        0 === e.length
          ? ((e = $('<div role="wrapper" />').addClass(d.style.wrapper)),
            a.wrap(e))
          : e.addClass(d.style.wrapper),
        (e = a.parent('div[role="wrapper"]')),
        d.width && e.css("width", d.width),
        a.val(d.value).addClass(d.style.input).attr("role", "input"),
        d.fontSize && a.css("font-size", d.fontSize),
        "bootstrap" === d.uiLibrary || "bootstrap4" === d.uiLibrary
          ? "small" === d.size
          ...
          : "small" === d.size
          ? e.addClass("small")
          : "large" === d.size && e.addClass("large"),
        c.on("click", function (b) {
          $("body")
            .children('[role="calendar"][guid="' + a.attr("data-guid") + '"]')
            .is(":visible")
            ? gj.datepicker.methods.close(a)
            : gj.datepicker.methods.open(a);
        }),
        a.on("blur", function () {
          a.timeout = setTimeout(function () {
            gj.datepicker.methods.close(a);
        ...
        e.append(c),
        (b = gj.datepicker.methods.createCalendar(a)),
        d.keyboardNavigation &&
          a.on("keydown", gj.datepicker.methods.createKeyDownHandler(a, b));
    },
    createCalendar: function (a) {
      var b,
        c,
        d = a.data(),
        e = $('<div role="calendar" type="month"/>')
          .addClass(d.style.calendar)
          .attr("guid", a.attr("data-guid")),
        f = $("<table/>"),
        g = $("<thead/>");
      for (
        d.fontSize && e.css("font-size", d.fontSize),
          b = gj.core.parseDate(d.value, d.format, d.locale),
          !b || isNaN(b.getTime())
            ? (b = new Date())
            : a.attr(
                "day",
          ...
          a.attr("month", b.getMonth()),
          a.attr("year", b.getFullYear()),
          c = $('<div role="navigator" />'),
          c.append(
            $("<div>" + d.icons.previousMonth + "</div>").on(
              "click",
              gj.datepicker.methods.prev(a)
            )
          ),
          c.append(
            $('<div role="period"></div>').on(
              "click",
              gj.datepicker.methods.changePeriod(a)
            )
          ),
          c.append(
            $("<div>" + d.icons.nextMonth + "</div>").on(
              "click",
              gj.datepicker.methods.next(a)
            )
          ),
          e.append(c),
          $row = $('<tr role="week-days" />'),
          d.calendarWeeks && $row.append("<th><div>&nbsp;</div></th>"),
          i = d.weekStartDay;
        i < gj.datepicker.messages[d.locale].weekDays.length;
        i++
      )
        $row.append(
          "<th><div>" +
            gj.datepicker.messages[d.locale].weekDays[i] +
            "</div></th>"
        );
    ...
    renderMonth: function (a) {
      ...
      for (
        clearTimeout(a.timeout),
          s.children("thead").show(),
          a.attr("day")
            ? ((c = a.attr("day").split("-")), (c = new Date(c[0], c[1], c[2])))
            : (c = new Date(void 0)),
          e = parseInt(a.attr("month"), 10),
          f = parseInt(a.attr("year"), 10),
          r.attr("type", "month"),
          r
            .find('div[role="period"]')
            .text(gj.core.messages[q.locale].monthNames[e] + " " + f),
          g = new Array(31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31),
          f % 4 == 0 && 1900 != f && (g[1] = 29),
          h = g[e],
          i = (new Date(f, e, 1).getDay() + 7 - q.weekStartDay) % 7,
          t.empty(),
          b = 0,
          $row = $("<tr />"),
          l = gj.datepicker.methods.getPrevMonth(e, f),
          j = 1;
        j <= i;
        j++
      )
        (d = g[l.month] - i + j),
          (p = new Date(l.year, l.month, d)),
          q.calendarWeeks &&
            1 === j &&
            $row.append(
              "<td><div>" +
                gj.datepicker.methods.getWeekNumber(p) +
                "</div></td>"
            ),
          (n =
          ...
          q.showOtherMonths &&
            ((o = $("<div>" + d + "</div>")),
            n.append(o),
            q.selectOtherMonths && gj.datepicker.methods.isSelectable(q, p)
              ? (n.addClass("gj-cursor-pointer"),
                o.on("click", gj.datepicker.methods.select(a, r, p)))
              : n.addClass("disabled")),
          $row.append(n),
          b++;
      for (j > 1 && t.append($row), k = new Date(), j = 1; j <= h; j++)
        (p = new Date(f, e, j)),
          0 == b &&
            (($row = $("<tr>")),
            q.calendarWeeks &&
          ...
          (n = $('<td day="' + j + '" />')),
          f === c.getFullYear() && e === c.getMonth() && j === c.getDate()
            ? n.addClass("selected")
            : f === k.getFullYear() && e === k.getMonth() && j === k.getDate()
            ? n.addClass("today")
            : n.addClass("current-month"),
          (o = $("<div>" + j + "</div>")),
          gj.datepicker.methods.isSelectable(q, p)
            ? (n.addClass("gj-cursor-pointer"),
              o.on("click", gj.datepicker.methods.select(a, r, p)))
            : n.addClass("disabled"),
          n.append(o),
          $row.append(n),
          7 == ++b && (t.append($row), (b = 0));
      for (m = gj.datepicker.methods.getNextMonth(e, f), j = 1; 0 != b; j++)
        (p = new Date(m.year, m.month, j)),
          (n =
            m.year === c.getFullYear() &&
            m.month === c.getMonth() &&
            j === c.getDate()
              ? $('<td class="selected" />')
              : $('<td class="other-month" />')),
    ...
    renderYear: function (a, b) {
      ...
      for (
        clearTimeout(a.timeout),
          ...
          c = parseInt(a.attr("year"), 10),
          b.attr("type", "year"),
          b.find('div[role="period"]').text(c),
          i.empty(),
          d = 0;
        d < 3;
        d++
      ) {
        for ($row = $("<tr />"), e = 4 * d; e <= 4 * d + 3; e++)
          (f = $(
            "<div>" + gj.core.messages[g.locale].monthShortNames[e] + "</div>"
          )),
            f.on("click", gj.datepicker.methods.selectMonth(a, b, e)),
            ($cell = $("<td></td>").append(f)),
            $row.append($cell);
        i.append($row);
      }
    ...
    renderDecade: function (a, b) {
      ...
      for (
        clearTimeout(a.timeout),
          ...
          d = c - (c % 10),
          b.attr("type", "decade"),
          b.find('div[role="period"]').text(d + " - " + (d + 9)),
          i.empty(),
          e = d - 1;
        e <= d + 10;
        e += 4
      ) {
        for ($row = $("<tr />"), f = e; f <= e + 3; f++)
          (g = $("<div>" + f + "</div>")),
            g.on("click", gj.datepicker.methods.selectYear(a, b, f)),
            ($cell = $("<td></td>").append(g)),
            $row.append($cell);
        i.append($row);
      }
    ...
    renderCentury: function (a, b) {
      ...
      for (
        clearTimeout(a.timeout),
          ...
          d = c - (c % 100),
          b.attr("type", "century"),
          b.find('div[role="period"]').text(d + " - " + (d + 99)),
          i.empty(),
          e = d - 10;
        e < d + 100;
        e += 40
      ) {
        for ($row = $("<tr />"), f = e; f <= e + 30; f += 10)
          (g = $("<div>" + f + "</div>")),
            g.on("click", gj.datepicker.methods.selectDecade(a, b, f)),
            ($cell = $("<td></td>").append(g)),
            $row.append($cell);
        i.append($row);
      }
    ...
    prev: function (a) {
      return function () {
        ...
        switch (g.attr("type")) {
          case "month":
            (c = parseInt(a.attr("month"), 10)),
              (d = parseInt(a.attr("year"), 10)),
              (b = gj.datepicker.methods.getPrevMonth(c, d)),
              a.attr("month", b.month),
              a.attr("year", b.year),
              gj.datepicker.methods.renderMonth(a);
            break;
          case "year":
            (d = parseInt(a.attr("year"), 10)),
              a.attr("year", d - 1),
              gj.datepicker.methods.renderYear(a, g);
            break;
          case "decade":
            (d = parseInt(a.attr("year"), 10)),
              (e = d - (d % 10)),
              a.attr("year", e - 10),
              gj.datepicker.methods.renderDecade(a, g);
            break;
          case "century":
            (d = parseInt(a.attr("year"), 10)),
              (f = d - (d % 100)),
              a.attr("year", f - 100),
              gj.datepicker.methods.renderCentury(a, g);
        }
        a.focus();
      };
    },
      ...
      return function () {
        ...
        switch (g.attr("type")) {
          case "month":
            (c = parseInt(a.attr("month"), 10)),
              (d = parseInt(a.attr("year"), 10)),
              (b = gj.datepicker.methods.getNextMonth(c, d)),
              a.attr("month", b.month),
              a.attr("year", b.year),
              gj.datepicker.methods.renderMonth(a);
            break;
    ...
    changePeriod: function (a) {
      return function (b) {
        ...
        switch (c.attr("type")) {
          case "month":
            gj.datepicker.methods.renderYear(a, c);
            break;
          case "year":
            gj.datepicker.methods.renderDecade(a, c);
            break;
          case "decade":
            gj.datepicker.methods.renderCentury(a, c);
            break;
          case "century":
    ...
    select: function (a, b, c) {
      return function (d) {
        var e,
          ...
          h = a.data();
        return (
          (e = gj.core.formatDate(c, h.format, h.locale)),
          a.val(e),
          gj.datepicker.events.change(a),
          a.attr("day", g + "-" + f + "-" + c.getDate()),
          a.attr("month", f),
          a.attr("year", g),
    ...
    selectMonth: function (a, b, c) {
      return function (b) {
        a.attr("month", c), gj.datepicker.methods.renderMonth(a);
      };
    },
    selectYear: function (a, b, c) {
      return function (d) {
        a.attr("year", c), gj.datepicker.methods.renderYear(a, b);
      };
    },
    selectDecade: function (a, b, c) {
      return function (d) {
        a.attr("year", c), gj.datepicker.methods.renderDecade(a, b);
      };
    },
    open: function (a) {
      var b =
      ...
      switch ((a.val() && a.value(a.val()), b.attr("type"))) {
        case "month":
          gj.datepicker.methods.renderMonth(a);
          break;
        case "year":
          gj.datepicker.methods.renderYear(a, b);
          break;
        case "decade":
          gj.datepicker.methods.renderDecade(a, b);
          break;
        case "century":
          gj.datepicker.methods.renderCentury(a, b);
      }
      b.show(),
        gj.core.setChildPosition(a[0], b[0]),
        a.focus(),
    ...
    createKeyDownHandler: function (a, b) {
      return function (c) {
        var d,
          ...
          g,
          h,
          i = gj.datepicker.methods.getActiveCell(b);
        (c = c || window.event),
          "none" !== window.getComputedStyle(b[0]).display &&
            ("38" == c.keyCode
              ? ((g = i.index()),
                ...
                h.is("[day]") ||
                  ...
                  (h = b
                    ...
                    .find("td:eq(" + g + ")"))),
                h.is("[day]") &&
                  (h.addClass("focused"), i.removeClass("focused")))
              : "40" == c.keyCode
              ? ((g = i.index()),
                (h = i
                  .closest("tr")
                ...
                h.is("[day]") ||
                  ...
                  (h = b
                    ...
                    .find("td:eq(" + g + ")")),
                  h.is("[day]") ||
                    (h = b.find("tbody tr:eq(1)").find("td:eq(" + g + ")"))),
                h.is("[day]") &&
                  (h.addClass("focused"), i.removeClass("focused")))
              : "37" == c.keyCode
              ? ((h = i.prev("td[day]:not(.disabled)")),
                0 === h.length &&
                  (h = i.closest("tr").prev("tr").find("td[day]").last()),
                0 === h.length &&
                  (gj.datepicker.methods.prev(a)(),
                  (h = b.find("tbody tr").last().find("td[day]").last())),
                h.length > 0 &&
                  (h.addClass("focused"), i.removeClass("focused")))
              : "39" == c.keyCode || "9" == c.keyCode
              ? ((h = i.next("[day]:not(.disabled)")),
                0 === h.length &&
                  (h = i.closest("tr").next("tr").find("td[day]").first()),
                0 === h.length &&
                  (gj.datepicker.methods.next(a)(),
                  (h = b.find("tbody tr").first().find("td[day]").first())),
                h.length > 0 &&
                  (h.addClass("focused"), i.removeClass("focused")))
              : "13" == c.keyCode
              ? ((f = parseInt(i.attr("day"), 10)),
                (d = parseInt(a.attr("month"), 10)),
                (e = parseInt(a.attr("year"), 10)),
                gj.datepicker.methods.select(a, b, new Date(e, d, f))())
        ...
        : ((d = gj.core.parseDate(b, e.format, e.locale)),
          d
            ? ((c = $("body").children(
              ...
              gj.datepicker.methods.select(a, c, d)())
            : a.val(""),
          a);
    },
    destroy: function (a) {
  ...
  (gj.timepicker = {
    plugins: {},
    messages: { "en-us": { am: "AM", pm: "PM", ok: "Ok", cancel: "Cancel" } },
  }),
  ...
  (gj.timepicker.methods = {
    ...
    initialize: function (a) {
      ...
      (c =
        ...
        e.append(c),
        (b = gj.timepicker.methods.createClock(a)),
        d.keyboardNavigation &&
          a.on("keydown", gj.timepicker.methods.createKeyDownHandler(a, b));
    },
    createClock: function (a) {
      var b,
        ...
        k = $(
          '<button class="' +
            c.style.button +
            '">' +
            gj.timepicker.messages[c.locale].ok +
            "</button>"
        ),
        l = $(
          '<button class="' +
            c.style.button +
            '">' +
            gj.timepicker.messages[c.locale].cancel +
            "</button>"
        ),
      ...
      return (
        ...
        j.on("mousedown", gj.timepicker.methods.mouseDownHandler(a, d)),
        j.on("mousemove", gj.timepicker.methods.mouseMoveHandler(a, d)),
        j.on("mouseup", gj.timepicker.methods.mouseUpHandler(a, d)),
        c.header &&
          (e.on("click", function () {
          ...
          "ampm" === c.mode &&
            (h.append(
              $(
                '<span role="am">' +
                  gj.timepicker.messages[c.locale].am +
                  "</span>"
              ).on("click", function () {
            ...
            h.append(
              $(
                '<span role="pm">' +
                  gj.timepicker.messages[c.locale].pm +
                  "</span>"
              ).on("click", function () {
                var b = gj.timepicker.methods.getHour(d);
                d.attr("mode", "pm"),
        ...
        c.footer &&
          ...
          m.append(l),
          k.on("click", gj.timepicker.methods.setTime(a, d)),
          m.append(k),
          d.append(m)),
        d.hide(),
        $("body").append(d),
    ...
    updateArrow: function (a, b, c) {
      ...
      (d = b.mouseX(a)),
        (e = b.mouseY(a)),
        (f = a.target.getBoundingClientRect()),
        "hours" == h.dialMode
          ? ((g = gj.timepicker.methods.getPointerValue(
              d - f.left,
              e - f.top,
              h.mode
            )),
            c.attr(
              "hour",
              "ampm" === h.mode && "pm" === c.attr("mode") && g < 12
                ? g + 12
                : g
            ))
          : "minutes" == h.dialMode &&
        ...
        "hours" == h.dialMode
          ...
          : "minutes" == h.dialMode &&
            0 == b.data().footer &&
            gj.timepicker.methods.setTime(b, c)(),
        gj.timepicker.methods.select(b, c);
    },
    select: function (a, b) {
      ...
      "hours" == d.dialMode && (0 == e || e > 12) && "24hr" === d.mode
        ? c.css("width", "calc(50% - 52px)")
        : c.css("width", "calc(50% - 20px)"),
        "hours" == d.dialMode
          ? c.css("transform", "rotate(" + (30 * e - 90).toString() + "deg)")
          : c.css("transform", "rotate(" + (6 * f - 90).toString() + "deg)"),
        c.show(),
        gj.timepicker.methods.update(a, b);
    },
    update: function (a, b) {
      var c = a.data(),
      ...
      g.children('[role="hour"]').text(e),
        g.children('[role="minute"]').text(gj.core.pad(f)),
        h.removeClass("selected"),
        h
          .filter(function (a) {
            return "hours" == c.dialMode
              ? parseInt($(this).text(), 10) == e
              : parseInt($(this).text(), 10) == f;
          })
          .addClass("selected"),
        "ampm" === c.mode &&
          (d >= 12
            ? (g.find('[role="pm"]').addClass("selected"),
              g.find('[role="am"]').removeClass("selected"))
            : (g.find('[role="am"]').addClass("selected"),
              g.find('[role="pm"]').removeClass("selected")));
    },
    ...
    mouseUpHandler: function (a, b) {
      return function (c) {
        gj.timepicker.methods.updateArrow(c, a, b),
          (a.mouseMove = !1),
          a.data().modal || (clearTimeout(a.timeout), a.focus());
      };
    },
    renderHours: function (a, b) {
      ...
      clearTimeout(a.timeout),
        ...
        a.data("dialMode", "hours"),
        gj.timepicker.methods.select(a, b);
    },
    ...
    open: function (a) {
      var b,
        ...
        d = a.data(),
        e = $("body").find(
          '[role="clock"][guid="' + a.attr("data-guid") + '"]'
        );
      return (
        (b = a.value()
        ...
        gj.timepicker.methods.renderHours(a, e),
        e.show(),
        e.closest('div[role="modal"]').show(),
        d.modal
          ? gj.core.center(e)
          : (gj.core.setChildPosition(a[0], e[0]), a.focus()),
